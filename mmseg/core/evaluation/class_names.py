...
def pantanal_classes():
    return ['background', 'tree']

def rios_classes():
    return ['background', 'river']

def burned_classes():
    return ['background', 'burned']
...
dataset_aliases = {
    ...
    'rios': ['rios', 'Rios', 'river', 'River'],
    'burned': ['burned', 'Burned', 'queimadas', 'BurnedPantanal'],
}
